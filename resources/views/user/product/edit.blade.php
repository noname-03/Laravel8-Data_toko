...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('user.product.update', [$user->id, $product->id]) }}" enctype="multipart/form-data"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="code_product" name="code_product"
                                placeholder="Masukan Kode Produk" required value="{{ $product->code_product }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="qty">Stok <span class="required">*</span></label>
                            <input type="text" class="form-control" id="qty" name="qty"
                                value="{{ $product->qty }}" placeholder="Masukan Kode Jumlah Stok" required>
                        </div>
